$(document).ready(function() {
	...
	// Get IE or Edge browser version
		...
		$(window).scroll(function(e){
			...
			article1 = parseInt($('#article1').offset().top) - curScroll;
			article2 = parseInt($('#article2').offset().top) - curScroll;
			article3 = parseInt($('#article3').offset().top) - curScroll;
			article4 = parseInt($('#article4').offset().top) - curScroll;
			article1Title = parseInt($('#article1-title').offset().top) - curScroll;
			article2Title = parseInt($('#article2-title').offset().top) - curScroll;
			article3Title = parseInt($('#article3-title').offset().top) - curScroll;
			article4Title = parseInt($('#article4-title').offset().top) - curScroll;
		});
	...
	// Create isMobile Function
        ...
        if(isMobile.detectMobile()){
        	$('#remote-on').attr('src','app/images/mobile-new-remote-on.png');
        	headingScrollPos = 90;
        } else{
        	headingScrollPos = 30;
        ...
        $(window).resize(function(){
        	if($(window).width() > 768){
        		$('#remote-on').attr('src','app/images/new-remote-on.png');	
        	} else {
        		$('#remote-on').attr('src','app/images/mobile-new-remote-on.png');
        	};

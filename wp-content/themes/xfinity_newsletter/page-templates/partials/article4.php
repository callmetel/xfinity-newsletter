<article id="article-4" class="article-container">
	<div class="container">
		...
		<div class="reveal">
			...
			<p>For our platform with XR18, it’s the hands-free conversational aspect of the experience. Previously, even though you could ask a question and get a response, you’d have to use your remote control to complete the task. Now the aim is to lose the remote altogether. We can’t do this by simply adding voice to an existing experience; the entire experience needs to be reimagined from the ground up.</p>
			<p class="highlight is-bold">Many customers admit that their use of voice control is high at first but drops off over time.</p>
			<p>Today’s X1 was designed for a remote while tomorrow’s UI must be designed for voice first.</p>

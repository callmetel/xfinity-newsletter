<article id="article-4" class="article-container section" data-midnight="black">
	<div class="container" id="the-word-on-voice">
		...
		<h4>As the list of voice-enabled devices grows, the segmentation among them can be clearly defined into three types of experiences:</h4>
		...
		<div class="callout">
			...
			<p><span class="is-bold is-purple">Next issue coming in Q2.<!-- <img src="http://xfinity-newsletter/wp-content/themes/xfinity_newsletter/app/images/end-quotation.png" alt="" class="end-quotation"> --></p>
		</div>

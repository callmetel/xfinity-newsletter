<article id="article-3" class="article-container">
	<div class="container">
		<p>This is what we work toward every day; new ways to use voice as a means to make homes smarter, safer, and easier to manage.</p>
		...
		<div class="reveal">
			<div class="question">
				...
				<h4>Does voice personally impact the experience?</h4>	
			</div>
			<div class="answer">
				<h4 class="letter-heading">A:</h4>
				<p>Let’s look at our buy flow as an example. We’ve reimagined the end-to-end experience featuring a “Help Me Decide” format that makes it easier to personalize packages. Customers are guided through decisions, offered assistance at key moments and given the ability to skim or dig into more detailed information at any time. The customer drives the experience, engaging directly in a friendly, personal way. Internet with a side of TV? Yes, please!</p>	
			</div>
			...
			<p>“Put on Game of Thrones, turn off the lights, and turn up the heat.”</p>
			<p>With voice technology, the possibilities are endless and as unique as the individuals we’re speaking to. We imagine a time when we can serve dynamic ads to different users based on their voice ID. Why not show movie-buff Mom a new trailer instead of the computer that Junior’s been asking about? We’re prepping for the potential as well as the actual future of voice, one utterance at a time.</p>
			<p>As we extend our Digital First efforts to more customer touch points&mdash; including call centers, tech and retail—we’re now, more than ever, committed to delivering a best-in-class experience you have to say to believe. </p>
			<p>“Hey X1, show me more.”</p>
			
			<a href="mailto:Heather_Hollis@comcast.com" class="no-decoration contact-link">Contact Heather: Heather_Hollis@comcast.com</a>
		</div>

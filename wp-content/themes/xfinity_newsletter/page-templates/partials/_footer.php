<section id="footer" class="gradient-wrap is-relative">
			...
			<div class="article absolute-bottom">
				...
				<div class="row">
					...
					<div class="right">
						...
						<a href="javascript:void(0)" class="logo no-decoration"><img src="http://localhost/wp-content/themes/xfinity_newsletter/app/images/xfinity-logo.svg" alt="print icon" class="xfinity-logo"></a>
					</div>	
				</div>
